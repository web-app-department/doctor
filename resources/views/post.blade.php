 ...
 <figure
      ...
      <ul
         ...
         <li
            ...
            <figure><a
               href="storage/post/app/public/{{$post->image}}" data-rel=lightbox-image-0 data-rl_title data-rl_caption title><img
               src="storage/app/public/post/{{$post->image}}" alt data-id=918 data-full-url="storage/app/public/post/{{$post->image}}" data-link="{{url('storage/post/'.$post->image)}}" class=wp-image-918 srcset=""{{url('storage/post/'.$post->image)}} "></a></figure>
         </li>
