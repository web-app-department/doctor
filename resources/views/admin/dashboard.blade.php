        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-cyan hover-expand-effect">
                    ...
                    <div class="content">
                        <div class="text">BLOG FAVORITES</div>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-red hover-expand-effect">
                    ...
                    <div class="content">
                        ...
                        <div class="number count-to" data-from="0" data-to="{{ $doctor->count() }}" data-speed="1000" data-fresh-interval="20"></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-orange hover-expand-effect">
                    ...
                    <div class="content">
                        <div class="text">TOTAL BLOG VIEWS</div>
                                ...
                                <tbody>
                                    @foreach($popular_posts as $key=>$post)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-primary waves-effect" target="_blank" href="{{ route('postview',$post->slug) }}">View</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
