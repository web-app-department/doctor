...
@section('content')
    <div class="container-fluid">
        <div class="block-header">
            <a class="btn btn-primary waves-effect" href="{{ route('admin.doctor.create') }}">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            ALL DOCTORS
                            <span class="badge bg-blue">{{ $doctors->count() }}</span>
                        </h2>
                    </div>
                    <div class="body">
                                    ...
                                    @foreach($doctors as $key=>$doctor)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button class="btn btn-danger waves-effect" type="button" onclick="deleteCategory({{ $doctor->id }})">
