...
@section('title','All Ready Prescription')
                                    ...
                                    @foreach($appoinment as $key=>$doctor)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('author.appointment.edit',$doctor->id) }}" target="_blank" class="btn btn-info waves-effect">
                                            ...
                                            <td><a target="_blank" href="{{ url('storage/doctor/'.$doctor->patinet_previous_test) }}">{{ $doctor->patinet_previous_test  }}</a></td>
